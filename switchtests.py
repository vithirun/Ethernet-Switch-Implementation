...
def hub_tests():
    ...
    reqpkt = mk_pkt("20:00:00:00:00:01", "10:00:00:00:00:01", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "An Ethernet frame should arrive on eth0 with destination address the same as eth0's MAC address")
    ...
    reqpkt = mk_pkt("20:00:00:00:00:01", "20:00:00:00:00:03", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "An Ethernet frame should arrive on eth0 with destination address 20:00:00:00:00:03")
    s.expect(PacketOutputEvent("eth1", reqpkt, "eth2", reqpkt, display=Ethernet), "The Ethernet frame with a destination address 20:00:00:00:00:03 should be forwarded out ports eth1 and eth2")
    return s
